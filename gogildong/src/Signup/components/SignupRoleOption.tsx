...
export default function SignupRoleOption({
  ...
  return (
    <button
      type="button"
      className={`flex w-full items-center justify-between gap-8 rounded-[1.25rem] border bg-white px-8 py-5.5 text-left transition-colors ${selected ? "border-neon-100 shadow-[0_0_12px_rgba(170,235,47,0.30)]" : "border-gray-20"}`}
      onClick={onClick}
    >
